...
echo  архивируем базу
rem  // архивируем базу, а затем снимаем код блокировки
...
:Ok1
echo  Производим тестирование и исправление >> %LOG%
echo  Производим тестирование и исправление
