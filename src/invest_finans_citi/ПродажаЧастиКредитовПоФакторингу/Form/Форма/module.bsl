...
Функция СоздатьДокОперация()
	...
	ДокОперация.Содержание = "Продаж частини кредитів згідно договору факторингу";
	ДокОперация.Комментарий = "Продаж частини кредитів згідно договору факторингу";
...
Функция СоздатьИЗаписатьНаборЗаписейПоСтроке(ТабличныйДокумент, ТекущаяСтрока, ДокОперация, РегХозрасчетныйСписаниеЗадолженности)	
	...
	//КонецЕсли;
		...
		РегЗапись.Содержание  = "Продажа Части Кредитов По Факторингу";
...
Процедура ПередОткрытием(Отказ, СтандартнаяОбработка)
	...
	СтатьяЗатрат = 	Справочники.СтатьиЗатрат.НайтиПоКоду("100000095");
