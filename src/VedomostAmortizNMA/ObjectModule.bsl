...
Процедура ЗаполнитьНачальныеНастройки() Экспорт
	...
	|	РегистрСведений.СостоянияНМАОрганизаций КАК СостоянияНМАОрганизаций
	|ГДЕ
	|	СостоянияНМАОрганизаций.Состояние <> &СостояниеПоступил
	|	И СостоянияНМАОрганизаций.Период В
	|			(ВЫБРАТЬ
	...
	|	ТекущееСостояние.ДокументУстановкиСостояния КАК ДокументВводаВЭксплуатацию
	|{ВЫБРАТЬ
	|	Организация.*,
	|	Подразделение.*,
	|	НематериальныйАктив.*,
