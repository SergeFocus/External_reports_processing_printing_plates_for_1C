...
Процедура ЗаполнитьНачальныеНастройки() Экспорт
	...
	МакетСоставаПоказателей = ЭтотОбъект.ПолучитьМакет("СоставПоказателей2013Мес7");
...
Процедура ЗаполнитьСведенияОбОрганизации()
	...
	мПереченьТаблиц.Области.РуководительИНН.Значение       = РегламентированнаяОтчетность.ПолучитьСведенияОбОрганизации(Организация, ДатаПодписи, СписокПоказателей).ИННРук;
	мПереченьТаблиц.Области.БухгалтерИНН.Значение          = РегламентированнаяОтчетность.ПолучитьСведенияОбОрганизации(Организация, ДатаПодписи, СписокПоказателей).ИННБух;
...
мСоставПоказателей = "СоставПоказателей2013Мес7";

// ОПИСАНИЕ ПАРМЕТРОВ ФОРМЫ
//
// Версия формы
мВерсияФормы = "01/07/2013";
