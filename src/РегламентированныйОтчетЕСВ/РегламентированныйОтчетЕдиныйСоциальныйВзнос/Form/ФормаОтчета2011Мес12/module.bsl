...
Процедура ЗаполнитьНачальныеНастройки() Экспорт
	...
	МакетСоставаПоказателей = ЭтотОбъект.ПолучитьМакет("СоставПоказателей2011Мес12");
...
Процедура Расчет()
	...
	мТаблица1.Области.П8_8.Значение   = ОкруглитьЧислоПоФормату(мТаблица1.Области.П3_3_1.Значение) 
								      + ОкруглитьЧислоПоФормату(мТаблица1.Области.П6_1_8.Значение)
								 	  - ОкруглитьЧислоПоФормату(мТаблица1.Области.П7_1_8.Значение);
...
Процедура ЗаполнитьАвто()  Экспорт
    ...
    П2_1_1 	= 0; 	П2_1_2	= 0;	П2_1_3	= 0;	П2_1_4	= 0;	П2_1_5 = 0;	П2_1_6	= 0;
	П3_1_1 	= 0;	П3_1_2 	= 0;    П3_1_3	= 0;  	П3_1_4	= 0;	П3_1_5 = 0; П3_1_6	= 0;
	...
	УстановитьЗначениеПоказателя("П2_1_1", 	П2_1_1);УстановитьЗначениеПоказателя("П2_1_2", П2_1_2);УстановитьЗначениеПоказателя("П2_1_3", П2_1_3);УстановитьЗначениеПоказателя("П2_1_4", П2_1_4);УстановитьЗначениеПоказателя("П2_1_5", П2_1_5);УстановитьЗначениеПоказателя("П2_1_6", П2_1_6);
	УстановитьЗначениеПоказателя("П3_1_1", 	П3_1_1);УстановитьЗначениеПоказателя("П3_1_2", П3_1_2);УстановитьЗначениеПоказателя("П3_1_3", П3_1_3);УстановитьЗначениеПоказателя("П3_1_4", П3_1_4);УстановитьЗначениеПоказателя("П3_1_5", П3_1_5);УстановитьЗначениеПоказателя("П3_1_6", П3_1_6);
	...
	УстановитьЗначениеПоказателя("П2_2_1", 	П2_2_1);УстановитьЗначениеПоказателя("П2_2_2", П2_2_2);
	УстановитьЗначениеПоказателя("П3_2_1", 	П3_2_1);УстановитьЗначениеПоказателя("П3_2_2", П3_2_2);
	...
	УстановитьЗначениеПоказателя("П4_3", 	П5_3);
...
Функция  СформироватьСписокТрудовыхОтношенийТаблица5()
	...
	Для Каждого стр ИЗ ДоговораГПХ Цикл
		...
		мТаблица5.Области[мИдГруппы5 + Формат(ТекНомер,"ЧЦ=4;ЧВН=0;ЧГ=;") + "Гражданин"].Значение  = стр.Гражданин;
		мТаблица5.Области[мИдГруппы5 + Формат(ТекНомер,"ЧЦ=4;ЧВН=0;ЧГ=;") + "ДРФО"].Значение       = стр.КодПоДРФО;
		мТаблица5.Области[мИдГруппы5 + Формат(ТекНомер,"ЧЦ=4;ЧВН=0;ЧГ=;") + "Фамилия"].Значение    = стр.Фамилия;
		мТаблица5.Области[мИдГруппы5 + Формат(ТекНомер,"ЧЦ=4;ЧВН=0;ЧГ=;") + "Имя"].Значение 		= стр.Имя;
		мТаблица5.Области[мИдГруппы5 + Формат(ТекНомер,"ЧЦ=4;ЧВН=0;ЧГ=;") + "Отчество"].Значение   = стр.Отчество;
		
		мТаблица5.Области[мИдГруппы5 + Формат(ТекНомер,"ЧЦ=4;ЧВН=0;ЧГ=;") + "ДатаНач"].Значение   = стр.ДатаНач;
		мТаблица5.Области[мИдГруппы5 + Формат(ТекНомер,"ЧЦ=4;ЧВН=0;ЧГ=;") + "ДатаКон"].Значение   = стр.ДатаКон;
		
		мТаблица5.Области[мИдГруппы5 + Формат(ТекНомер,"ЧЦ=4;ЧВН=0;ЧГ=;") + "Категория"].Значение   = 3;
...
Процедура СформироватьНачисленияВзносыТаблица6(СписокРаботниковСоСпецСтажем)
	...
	|	ВЫБОР КОГДА 
	|	 ВзносыВФонды.ТипНачисления = 0 И ВзносыВФонды.КодКатегорииЗЛ В (&МассивКодыБольничные) 
...
мСоставПоказателей = "СоставПоказателей2011Мес12";

// ОПИСАНИЕ ПАРМЕТРОВ ФОРМЫ
//
// Версия формы
мВерсияФормы = "01/12/2011";
