...
Перем Начисление;
Перем ОперацияНачислениеПени;
Перем ОперацияНачислениеПроцентов;
Перем РегХозрасчетныйНачислениеПени;
...
Функция СоздатьППВходящее(ТабличныйДокумент, ТекущаяСтрока)	
	...
	Попытка	
		...
		Если Тело > 0 Тогда
			Выполнение = ЗаполнениеППВх(ДатаОперации, ДоговорКонтрагента, Контрагент, ПараметрОбъектКопирования, Тело, Справочники.СтатьиДвиженияДенежныхСредств.НайтиПоНаименованию("1111 Погашення кредиту" ), ПланыСчетов.Хозрасчетный.НайтиПоКоду("37711"), "погашення кредиту"); 		
		КонецЕсли;
		
		//Відсотки за кредитом	
		//ПлатежноеПоручениеВходящее
		Если Процент > 0 Тогда
			Выполнение = ЗаполнениеППВх(ДатаОперации, ДоговорКонтрагента, Контрагент, ПараметрОбъектКопирования, Процент, Справочники.СтатьиДвиженияДенежныхСредств.НайтиПоНаименованию("1112 Відсотки за кредитом" ), ПланыСчетов.Хозрасчетный.НайтиПоКоду("373"), "Відсотки за кредитом"); 		
		...
		Если ШтрафПеня > 0 Тогда 
			Выполнение = ЗаполнениеППВх(ДатаОперации, ДоговорКонтрагента, Контрагент, ПараметрОбъектКопирования, ШтрафПеня, Справочники.СтатьиДвиженияДенежныхСредств.НайтиПоНаименованию("1113 Штраф за прострочення кредиту" ), ПланыСчетов.Хозрасчетный.НайтиПоКоду("374"), "Штраф за прострочення кредиту"); 		
