...
Функция СоздатьППИсходящее(ТабличныйДокумент, ТекущаяСтрока)	
	...
	ДатаВыдачиКредита = ПреобразоватьВДату(ТекущаяСтрока.ДатаВыдачиКредита); 
	...
	Попытка	
		...
		если Контрагент =  Справочники.Контрагенты.ПустаяСсылка() Тогда
			...
			Иначе 
				...
				НовыйДоговорКонтрагента.Организация =  Организация;
		...
		НовыйДокППИх.СчетОрганизации = СчетОрганизации;
...
Процедура ПередОткрытием(Отказ, СтандартнаяОбработка)
	...
	СтатьяДвиженияДенежныхСредств = Справочники.СтатьиДвиженияДенежныхСредств.НайтиПоНаименованию("1110-Видача кредиту" );
	СчетУчетаРасчетовСКонтрагентом = ПланыСчетов.Хозрасчетный.НайтиПоКоду("37711");
